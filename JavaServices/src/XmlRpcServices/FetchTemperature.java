...
public class FetchTemperature {
    ...
    public String getCityTemperature(String cityName) throws MalformedURLException, ProtocolException, IOException, ParserConfigurationException, XPathExpressionException{
